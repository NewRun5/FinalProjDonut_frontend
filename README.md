...
## 커밋 메시지 작성 가이드
커밋 메시지는 일관성 있게 작성해주세요!<br>
명확한 커밋 메시지는 팀 내에서 변경 사항을 효과적으로 전달하고 추적할 수 있도록 도와줍니다.<br>
구체적으로 작성 부탁드립니다! :D <br><br><br>
...
[SECURITY][VULNERABILITY][REMOVE]보안 취약점 관련 기능 삭제<br><br>
...
이 가이드를 통해 팀원간 일관된 형식으로 커밋 메시지를 작성하여, <br>
개발 과정이 더욱 효율적이고 조직적으로 이루어질 수 있도록 합시다! <br>
추가적인 수정이나 요청이 필요하시면 말씀해 주세요!
